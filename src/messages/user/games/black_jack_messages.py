...
class BlackJackMessages(BotGamesMessagesBase, CreatableGamesMessages):
    ...
    def get_category_description(player_name: str) -> str:
        texts = (
            ...
            'DICY: Пароль! Не знаешь пароля, не будет тебе казино. \nЛааадно, шучу) Заходите конечно! Только не разгроми тут от злости ничего, а то до конца жизни будешь залоги выплачивать за золотой интерьер.',
            ...
            'Ты заходишь в главный зал казино, где все дорогие украшения помещения так и говорят тебе: "Ты можешь уйти отсюда победителем, а можешь... \nЛучше об этом не думать!"',
