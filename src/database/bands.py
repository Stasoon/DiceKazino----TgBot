...
async def create_band(
        creator_telegram_id: int, title: str, league: BandLeague = BandLeague.CROOKS
) -> Band | None:
    ...
    # Создаём новую банду
    band = await Band.create(title=title, league=league, creator=creator)
...
async def update_band_league(band_id: int, new_league: BandLeague):
